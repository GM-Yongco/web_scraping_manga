...
class DynastyMangaChapter(MangaChapter):
	...
	def get_pannel_links(self) -> None:
		...
		print(f"GOT PANNEL LINKS: {self._chapter_title}")

# ========================================================================
class DynastyMangaDetails(MangaDetails):
	# redefined to change the manga_chapters list to be of the Dynasty type
	def __init__(self, 
		manga_link:str = "0",
	...
	def add_chapter(self, 
		...
		self._manga_chapters.append(DynastyMangaChapter(
